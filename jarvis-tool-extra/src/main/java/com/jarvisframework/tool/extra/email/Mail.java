...
public class Mail {
	 ...
	 * @return {@link cn.hutool.extra.mail.Mail}
	 */
	 ...
	 * @return {@link cn.hutool.extra.mail.Mail}
	 */
	public static cn.hutool.extra.mail.Mail create() {
		return new cn.hutool.extra.mail.Mail();
	}
	...
	public Mail addImage(String cid, InputStream imageStream, String contentType) {
		...
		try {
			imgSource = new ByteArrayDataSource(imageStream, ObjectUtils.defaultIfNull(contentType, "image/jpeg"));
		} catch (IOException e) {
