...
import com.jarvisframework.tool.core.util.ServiceLoaderUtils;
import com.jarvisframework.tool.log.dialect.console.ConsoleLogFactory;
import com.jarvisframework.tool.log.dialect.jdk.JdkLogFactory;
...
public abstract class LogFactory {
    ...
    public static Log get() {
        return get(CallerUtils.getCallerCaller());
    }
    ...
    private static LogFactory doCreate() {
        final LogFactory factory = ServiceLoaderUtils.loadFirstAvailable(LogFactory.class);
        if (null != factory) {
            return factory;
        }
