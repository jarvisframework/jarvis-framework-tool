...
/**
 * <p>全局缓存清理定时器池，用于在需要过期支持的缓存对象中超时任务池</p>
 *
 * @author 王涛
 * @since 1.0, 2020-07-29 14:19:41
 */
public enum GlobalPruneTimerEnum {
    /**
     * 单例对象
     */
    INSTANCE;
    ...
    public void create() {
        ...
        this.pruneTimer = new ScheduledThreadPoolExecutor(1, r -> ThreadUtils.newThread(r, StringUtils.format("Pure-Timer-{}", cacheTaskNumber.getAndIncrement())));
    }
