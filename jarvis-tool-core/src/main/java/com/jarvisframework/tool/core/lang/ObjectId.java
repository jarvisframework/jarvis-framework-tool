...
import com.jarvisframework.tool.core.util.ClassLoaderUtils;
import com.jarvisframework.tool.core.util.RandomUtils;
...
public class ObjectId {
     ...
     */
    private static final AtomicInteger nextInc = new AtomicInteger(RandomUtils.randomInt());
    ...
    public static byte[] nextBytes() {
        ...
        // 4位
        bb.putInt((int) DateUtils.currentSeconds());
        // 4位
        bb.putInt(machine);
        // 4位
