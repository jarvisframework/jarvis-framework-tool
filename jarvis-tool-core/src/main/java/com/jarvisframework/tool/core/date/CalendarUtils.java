...
/**
 * <p>针对{@link Calendar} 对象封装工具类</p>
 *
 * @author 王涛
 * @since 1.0, 2020-07-10 17:42:12
 */
public class CalendarUtils {
    ...
    public static String yearAndQuarter(Calendar cal) {
        return StringUtils.builder().append(cal.get(Calendar.YEAR)).append(cal.get(Calendar.MONTH) / 3 + 1).toString();
    }
