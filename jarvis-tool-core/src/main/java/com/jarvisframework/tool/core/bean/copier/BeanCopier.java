...
import com.jarvisframework.tool.core.bean.copier.provider.BeanValueProvider;
import com.jarvisframework.tool.core.bean.copier.provider.MapValueProvider;
...
public class BeanCopier<T> implements Copier<T>, Serializable {
    ...
    private void beanToMap(Object bean, Map targetMap) {
        final Collection<PropDesc> props = BeanUtils.getBeanDesc(bean.getClass()).getProps();
    ...
    private void valueProviderToBean(ValueProvider<String> valueProvider, Object bean) {
        ...
        final Collection<PropDesc> props = BeanUtils.getBeanDesc(actualEditable).getProps();
        Field field;
        String fieldName;
        Object value;
        Method setterMethod;
