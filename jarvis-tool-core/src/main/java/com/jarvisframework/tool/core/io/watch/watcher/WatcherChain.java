package com.jarvisframework.tool.core.io.watch.watcher;

import com.jarvisframework.tool.core.collection.CollectionUtils;
import com.jarvisframework.tool.core.io.watch.Watcher;
import com.jarvisframework.tool.core.lang.Chain;
...
public class WatcherChain implements Watcher, Chain<Watcher, WatcherChain> {
    ...
    public WatcherChain(Watcher... watchers) {
        chain = CollectionUtils.newArrayList(watchers);
    }
