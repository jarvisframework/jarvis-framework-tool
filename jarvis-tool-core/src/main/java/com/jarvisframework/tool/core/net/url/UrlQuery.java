package com.jarvisframework.tool.core.net.url;
...
import com.jarvisframework.tool.core.map.TableMap;
...
public class UrlQuery {
    ...
    private static String toStr(Object value) {
        ...
        if (value instanceof Iterable) {
            result = CollectionUtils.join((Iterable<?>) value, ",");
        } else if (value instanceof Iterator) {
            result = IterUtils.join((Iterator<?>) value, ",");
        } else {
    ...
    private void addParam(String key, String value, Charset charset) {
        if (null != key) {
            ...
            this.query.put(UrlUtils.decode(value, charset), StringUtils.EMPTY);
        }
    }
}
