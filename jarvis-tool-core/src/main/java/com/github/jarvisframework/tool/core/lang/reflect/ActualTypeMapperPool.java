package com.github.jarvisframework.tool.core.lang.reflect;
...
public class ActualTypeMapperPool {
    ...
    private static Map<Type, Type> createTypeMap(Type type) {
        ...
        while (null != type) {
            final ParameterizedType parameterizedType = TypeUtils.toParameterizedType(type);
