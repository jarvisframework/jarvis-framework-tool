...
public class DateTime extends Date {
     ...
     *
     * @param datePart 调整的部分 {@link DateFieldEnum}
     ...
     *
     * @param field 表示日期的哪个部分的枚举 {@link DateFieldEnum}
     * @return 某个部分的值
     */
     ...
     */
    public int year() {
        return getField(DateFieldEnum.YEAR);
    }

    /**
     * 获得当前日期所属季度，从1开始计数<br>
     *
     * @return 第几个季度 {@link QuarterEnum}
     */
    public int quarter() {
        return month() / 3 + 1;
    }
     ...
     */
    public int month() {
        return getField(DateFieldEnum.MONTH);
    }
     ...
     *
     * @return 周
     * @see #setFirstDayOfWeek(WeekEnum)
     */
    public int weekOfYear() {
        return getField(DateFieldEnum.WEEK_OF_YEAR);
    }
    ...
    public int weekOfMonth() {
        return getField(DateFieldEnum.WEEK_OF_MONTH);
    }
    ...
    public int dayOfMonth() {
        return getField(DateFieldEnum.DAY_OF_MONTH);
    }
    ...
    public int dayOfYear() {
        return getField(DateFieldEnum.DAY_OF_YEAR);
    }
    ...
    public int dayOfWeek() {
        return getField(DateFieldEnum.DAY_OF_WEEK);
    }
    ...
    public int dayOfWeekInMonth() {
        return getField(DateFieldEnum.DAY_OF_WEEK_IN_MONTH);
    }
    ...
    public int hour(boolean is24HourClock) {
        return getField(is24HourClock ? DateFieldEnum.HOUR_OF_DAY : DateFieldEnum.HOUR);
    }
     ...
     */
    public int minute() {
        return getField(DateFieldEnum.MINUTE);
    }
     ...
     */
    public int second() {
        return getField(DateFieldEnum.SECOND);
    }
    ...
    public int millisecond() {
        return getField(DateFieldEnum.MILLISECOND);
    }
     ...
     */
    public boolean isAM() {
        return Calendar.AM == getField(DateFieldEnum.AM_PM);
    }
     ...
     */
    public boolean isPM() {
        return Calendar.PM == getField(DateFieldEnum.AM_PM);
    }
     ...
     *
     * @param date 对比的日期
     * @param unit 单位 {@link DateUnitEnum}
     * @return 相差时长
     */
    public long between(Date date, DateUnitEnum unit) {
     ...
     * @return 相差时长
     */
    public String between(Date date, DateUnitEnum unit, BetweenFormat.Level formatLevel) {
     ...
     * 如果为不可变对象，以下方法将返回新方法：
     * <ul>
     * <li>{@link DateTime#offset(DateFieldEnum, int)}</li>
     * <li>{@link DateTime#setField(DateFieldEnum, int)}</li>
