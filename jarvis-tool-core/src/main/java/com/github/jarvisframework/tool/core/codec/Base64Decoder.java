package com.github.jarvisframework.tool.core.codec;
...
public class Base64Decoder {
    ...
    public static byte[] decode(CharSequence source) {
        return decode(StringUtils.bytes(source, DEFAULT_CHARSET));
    }
    ...
    public static byte[] decode(byte[] in, int pos, int length) {
        ...
        final Base64Decoder.IntWrapper offset = new Base64Decoder.IntWrapper(pos);
     ...
     */
    private static byte getNextValidDecodeByte(byte[] in, Base64Decoder.IntWrapper pos, int maxPos) {
        byte base64Byte;
        byte decodeByte;
