...
import com.github.jarvisframework.tool.core.io.file.FileReader;
import com.github.jarvisframework.tool.core.io.file.FileWriter;
import com.github.jarvisframework.tool.core.io.file.*;
...
public class FileUtils {
     ...
     * 类Unix路径分隔符
     */
    private static final char UNIX_SEPARATOR = CharUtils.SLASH;
    /**
     * Windows路径分隔符
     */
    private static final char WINDOWS_SEPARATOR = CharUtils.BACKSLASH;
    /**
     * Windows下文件名中的无效字符
     */
    ...
    public static void move(File src, File dest, boolean isOverride) throws IORuntimeException {
        ...
        if (false == src.renameTo(dest)) {
            ...
            try {
                ...
                throw new IORuntimeException(StringUtils.format("Move [{}] to [{}] failed!", src, dest), e);
            }
            // 复制后删除源
            del(src);
        }
    ...
    public static boolean isAbsolutePath(String path) {
        ...
        // 给定的路径已经是绝对路径了
        return StringUtils.C_SLASH == path.charAt(0) || path.matches("^[a-zA-Z]:([/\\\\].*)?");
    }
    ...
    public static String normalize(String path) {
        ...
        // 统一使用斜杠
        pathToUse = pathToUse.replaceAll("[/\\\\]+", StringUtils.SLASH).trim();
        ...
        if (prefixIndex > -1) {
            ...
            if (false == prefix.contains(StringUtils.SLASH)) {
        ...
        for (int i = pathList.size() - 1; i >= 0; i--) {
            ...
            // 只处理非.的目录，即只处理非当前目录
            if (false == StringUtils.DOT.equals(element)) {
    ...
    public static <T extends Collection<String>> T readUtf8Lines(String path, T collection) throws IORuntimeException {
        return readLines(path, CharsetUtils.CHARSET_UTF_8, collection);
    }
    ...
    public static <T extends Collection<String>> T readUtf8Lines(File file, T collection) throws IORuntimeException {
        return readLines(file, CharsetUtils.CHARSET_UTF_8, collection);
    }
    ...
    public static <T extends Collection<String>> T readUtf8Lines(URL url, T collection) throws IORuntimeException {
        return readLines(url, CharsetUtils.CHARSET_UTF_8, collection);
    }
    ...
    public static List<String> readUtf8Lines(URL url) throws IORuntimeException {
        return readLines(url, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static List<String> readUtf8Lines(String path) throws IORuntimeException {
        return readLines(path, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static List<String> readUtf8Lines(File file) throws IORuntimeException {
        return readLines(file, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static void readUtf8Lines(File file, LineHandler lineHandler) throws IORuntimeException {
        readLines(file, CharsetUtils.CHARSET_UTF_8, lineHandler);
    }
    ...
    public static void readLines(RandomAccessFile file, Charset charset, LineHandler lineHandler) {
        ...
        try {
            while ((line = file.readLine()) != null) {
                lineHandler.handle(CharsetUtils.convert(line, CharsetUtils.CHARSET_ISO_8859_1, charset));
            }
        } catch (IOException e) {
            throw new IORuntimeException(e);
        }
    ...
    public static String readLine(RandomAccessFile file, Charset charset) {
        ...
        if (null != line) {
            return CharsetUtils.convert(line, CharsetUtils.CHARSET_ISO_8859_1, charset);
        }
    ...
    public static File writeUtf8String(String content, String path) throws IORuntimeException {
        return writeString(content, path, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static File appendUtf8String(String content, String path) throws IORuntimeException {
        return appendString(content, path, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static File appendUtf8String(String content, File file) throws IORuntimeException {
        return appendString(content, file, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static <T> File writeUtf8Lines(Collection<T> list, String path) throws IORuntimeException {
        return writeLines(list, path, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static <T> File writeUtf8Lines(Collection<T> list, File file) throws IORuntimeException {
        return writeLines(list, file, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static <T> File appendUtf8Lines(Collection<T> list, File file) throws IORuntimeException {
        return appendLines(list, file, CharsetUtils.CHARSET_UTF_8);
    }
    ...
    public static <T> File appendUtf8Lines(Collection<T> list, String path) throws IORuntimeException {
        return appendLines(list, path, CharsetUtils.CHARSET_UTF_8);
    }
     ...
     * @return 被转换编码的文件
     * @see CharsetUtils#convert(File, Charset, Charset)
     * @since 3.1.0
     */
    ...
    public static void tail(File file, LineHandler handler) {
        tail(file, CharsetUtils.CHARSET_UTF_8, handler);
    }
