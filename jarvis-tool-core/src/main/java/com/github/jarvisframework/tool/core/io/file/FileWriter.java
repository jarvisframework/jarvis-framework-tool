...
public class FileWriter extends FileWrapper {
     ...
     * @since 3.1.0
     */
    public <T> File writeLines(Collection<T> list, LineSeparatorEnum lineSeparator, boolean isAppend) throws IORuntimeException {
     ...
     * @since 4.0.5
     */
    public File writeMap(Map<?, ?> map, LineSeparatorEnum lineSeparator, String kvSeparator, boolean isAppend) throws IORuntimeException {
        if (null == kvSeparator) {
            kvSeparator = " = ";
        }
        try (PrintWriter writer = getPrintWriter(isAppend)) {
     ...
     * @since 4.0.5
     */
    private void printNewLine(PrintWriter writer, LineSeparatorEnum lineSeparator) {
