...
import com.github.jarvisframework.tool.core.lang.UUID;
import com.github.jarvisframework.tool.core.lang.WeightRandom;
import com.github.jarvisframework.tool.core.lang.WeightRandom.WeightObj;
...
public class RandomUtils {
    ...
    public static String randomUUID() {
        return com.github.jarvisframework.tool.core.lang.UUID.randomUUID().toString();
    }
    ...
    public static DateTime randomDay(int min, int max) {
        return randomDate(DateUtils.date(), DateFieldEnum.DAY_OF_YEAR, min, max);
    }
     ...
     * @since 4.5.8
     */
    public static DateTime randomDate(Date baseDate, DateFieldEnum dateField, int min, int max) {
        if (null == baseDate) {
