...
public class TimeInterval implements Serializable {
    ...
    public String intervalPretty() {
        return DateUtils.formatBetween(intervalMs());
    }
    ...
    public long intervalSecond() {
        return intervalMs() / DateUnitEnum.SECOND.getMillis();
    }
    ...
    public long intervalMinute() {
        return intervalMs() / DateUnitEnum.MINUTE.getMillis();
    }
    ...
    public long intervalHour() {
        return intervalMs() / DateUnitEnum.HOUR.getMillis();
    }
    ...
    public long intervalDay() {
        return intervalMs() / DateUnitEnum.DAY.getMillis();
    }
    ...
    public long intervalWeek() {
        return intervalMs() / DateUnitEnum.WEEK.getMillis();
    }
