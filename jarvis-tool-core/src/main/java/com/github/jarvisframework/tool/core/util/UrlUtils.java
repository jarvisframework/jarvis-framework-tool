...
public class UrlUtils {
    ...
    public static String encodeAll(String url, Charset charset) throws UtilException {
        ...
        return com.github.jarvisframework.tool.core.net.URLEncoder.ALL.encode(url, charset);
    }
    ...
    public static String encode(String url, Charset charset) {
        ...
        return com.github.jarvisframework.tool.core.net.URLEncoder.DEFAULT.encode(url, charset);
    }
    ...
    public static String encodeQuery(String url, Charset charset) {
        ...
        return com.github.jarvisframework.tool.core.net.URLEncoder.QUERY.encode(url, charset);
    }
