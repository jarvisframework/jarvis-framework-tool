package com.github.jarvisframework.tool.core.annotation;
...
public class CombinationAnnotationElement implements AnnotatedElement, Serializable {
     ...
     * 元注解
     */
    private static final Set<Class<? extends Annotation>> META_ANNOTATIONS = CollectionUtils.newHashSet(
            Target.class,
            Retention.class,
            Inherited.class,
            Documented.class,
