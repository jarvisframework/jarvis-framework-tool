 ...
 *
 * @author Doug Wang
 * @since 1.0, 2020-07-24 17:09:28
 */
public class BetweenFormat implements Serializable {
    ...
    public String format() {
        ...
        if (betweenMs > 0) {
            long day = betweenMs / DateUnitEnum.DAY.getMillis();
            long hour = betweenMs / DateUnitEnum.HOUR.getMillis() - day * 24;
            long minute = betweenMs / DateUnitEnum.MINUTE.getMillis() - day * 24 * 60 - hour * 60;

            final long BetweenOfSecond = ((day * 24 + hour) * 60 + minute) * 60;
            long second = betweenMs / DateUnitEnum.SECOND.getMillis() - BetweenOfSecond;
