...
import com.github.jarvisframework.tool.core.comparator.VersionComparator;
...
import com.github.jarvisframework.tool.core.text.StringFormatter;
import com.github.jarvisframework.tool.core.text.StringSpliter;
import com.github.jarvisframework.tool.core.text.TextSimilarity;
...
// ------------------------------------------------------------------------ Blank
    ...
    /**
     * 是否存都不为{@code null}或空对象，通过{@link StringUtils#hasEmpty(CharSequence...)} 判断元素
     *
    ...
    /**
     * 是否存都不为{@code null}或空对象或空白符的对象，通过{@link StringUtils#hasBlank(CharSequence...)} 判断元素
     *
     * @param args 被检查的对象,一个或者多个
     * @return 是否都不为空
     * @since 5.3.6
    ...
    public static String repeatAndJoin(CharSequence str, int count, CharSequence conjunction) {
        ...
        final StringBuilder builder = StringBuilder.create();
     ...
     *
     * @return com.github.jarvisframework.tool.core.text.StringBuilder对象
     * @since 4.0.1
     */
     ...
     *
     * @param capacity 初始大小
     * @returncom.github.jarvisframework.tool.core.text.StringBuilder对象
     * @since 4.0.1
     */
    public static StringBuilder strBuilder(int capacity) {
        return StringBuilder.create(capacity);
    }
     ...
     * @return com.github.jarvisframework.tool.core.text.StringBuilder对象
     */
    public static StringBuilder strBuilder(CharSequence... strs) {
        return StringBuilder.create(strs);
    }
    ...
    public static String replace(CharSequence str, int fromIndex, CharSequence searchStr, CharSequence replacement, boolean ignoreCase) {
        ...
        final StringBuilder result = StringBuilder.create(strLength + 16);
        if (0 != fromIndex) {
    ...
    public static String move(CharSequence str, int startInclude, int endExclude, int moveLength) {
        ...
        final StringBuilder strBuilder = StringBuilder.create(len);
        if (moveLength > 0) {
