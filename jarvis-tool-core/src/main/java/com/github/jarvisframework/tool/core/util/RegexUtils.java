...
public class RegexUtils {
     ...
     * 正则表达式匹配中文字符串
     */
    public final static String RE_CHINESE_STR = RE_CHINESE + "+";

    /**
     * 正则中需要被转义的关键字
     */
    public final static Set<Character> RE_KEYS = CollectionUtils.newHashSet('$', '(', ')', '*', '+', '.', '[', ']', '?', '\\', '^', '{', '}', '|');
    ...
    public static String extractMulti(Pattern pattern, CharSequence content, String template) {
        ...
        //提取模板中的编号
        final TreeSet<Integer> varNums = new TreeSet<>((o1, o2) -> ObjectUtils.compare(o2, o1));
