...
import com.github.jarvisframework.tool.core.lang.copier.SrcToDestCopier;
...
public class FileCopier extends SrcToDestCopier<File, FileCopier> {
    ...
    private void internalCopyDirContent(File src, File dest) throws IORuntimeException {
        ...
        if (false == dest.exists()) {
            ...
            throw new IORuntimeException(StringUtils.format("Src [{}] is a directory but dest [{}] is a file!", src.getPath(), dest.getPath()));
        }
