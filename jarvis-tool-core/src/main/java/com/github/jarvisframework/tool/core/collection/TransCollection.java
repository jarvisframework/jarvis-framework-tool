...
/**
 * <p>使用给定的转换函数，转换源集合为新类型的集合</p>
 *
 * @author Doug Wang
 * @since 1.0, 2020-09-23 14:07:29
 */
public class TransCollection<F, T> extends AbstractCollection<T> {
    ...
    public Iterator<T> iterator() {
        return IterUtils.trans(fromCollection.iterator(), function);
    }
    ...
    public Spliterator<T> spliterator() {
        return SpliteratorUtils.trans(fromCollection.spliterator(), function);
    }
