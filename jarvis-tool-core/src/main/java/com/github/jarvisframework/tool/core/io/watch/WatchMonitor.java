...
import com.github.jarvisframework.tool.core.io.watch.watcher.WatcherChain;
...
public class WatchMonitor extends WatchServer {
     ...
     * 事件丢失
     */
    public static final WatchEvent.Kind<?> OVERFLOW = WatchKindEnum.OVERFLOW.getValue();
    /**
     * 修改事件
     */
    public static final WatchEvent.Kind<?> ENTRY_MODIFY = WatchKindEnum.MODIFY.getValue();
    /**
     * 创建事件
     */
    public static final WatchEvent.Kind<?> ENTRY_CREATE = WatchKindEnum.CREATE.getValue();
    /**
     * 删除事件
     */
    public static final WatchEvent.Kind<?> ENTRY_DELETE = WatchKindEnum.DELETE.getValue();
    /**
     * 全部事件
     */
    public static final WatchEvent.Kind<?>[] EVENTS_ALL = WatchKindEnum.ALL;
    ...
    public void init() throws WatchException {
        ...
        if (false == Files.exists(this.path, LinkOption.NOFOLLOW_LINKS)) {
            ...
            if (null != lastPathEle) {
                ...
                if (StringUtils.contains(lastPathEleStr, StringUtils.C_DOT) && false == StringUtils.endWithIgnoreCase(lastPathEleStr, ".d")) {
