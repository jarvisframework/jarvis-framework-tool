...
public class MapConverter extends AbstractConverter<Map<?, ?>> {
    ...
    private void convertMapToMap(Map<?, ?> srcMap, Map<Object, Object> targetMap) {
        ...
        for (Entry<?, ?> entry : srcMap.entrySet()) {
            key = TypeUtils.isUnknown(this.keyType) ? entry.getKey() : convert.convert(this.keyType, entry.getKey());
            value = TypeUtils.isUnknown(this.valueType) ? entry.getValue() : convert.convert(this.valueType, entry.getValue());
