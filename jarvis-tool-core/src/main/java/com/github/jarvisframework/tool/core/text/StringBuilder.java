...
public class StringBuilder implements CharSequence, Appendable, Serializable {
     ...
     * @return {@link StringBuilder}
     */
    public static StringBuilder create(int initialCapacity) {
     ...
     * @since 4.0.1
     */
    public static StringBuilder create(CharSequence... strs) {
        return new StringBuilder(strs);
    }
     ...
     * @since 4.0.1
     */
    public StringBuilder(CharSequence... strs) {
     ...
     * @return this
     */
    public StringBuilder append(char[] src, int srcPos, int length) {
     ...
     * @return this
     */
    public StringBuilder insert(int index, char[] src, int srcPos, int length) {
     ...
     * @return this
     */
    public StringBuilder insert(int index, CharSequence csq) {
        if (null == csq) {
            csq = "null";
        }
        int len = csq.length();
     ...
     * @return this
     */
    public StringBuilder insert(int index, CharSequence csq, int start, int end) {
        if (csq == null) {
            csq = "null";
        }
     ...
     * @return this
     */
    public StringBuilder getChars(int srcBegin, int srcEnd, char[] dst, int dstBegin) {
        if (srcBegin < 0) {
            srcBegin = 0;
        }
        if (srcEnd < 0) {
     ...
     */
    public StringBuilder del(int start, int end) throws StringIndexOutOfBoundsException {
        if (start < 0) {
            start = 0;
        }
