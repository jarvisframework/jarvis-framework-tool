...
public class ModifierUtils {
     ...
     */
    public static boolean hasModifier(Class<?> clazz, ModifierUtils.ModifierType... modifierTypes) {
     ...
     * @return 是否有指定修饰符，如果有返回true，否则false，如果提供参数为null返回false
     */
    public static boolean hasModifier(Constructor<?> constructor, ModifierUtils.ModifierType... modifierTypes) {
     ...
     * @return 是否有指定修饰符，如果有返回true，否则false，如果提供参数为null返回false
     */
    public static boolean hasModifier(Method method, ModifierUtils.ModifierType... modifierTypes) {
     ...
     * @return 是否有指定修饰符，如果有返回true，否则false，如果提供参数为null返回false
     */
    public static boolean hasModifier(Field field, ModifierUtils.ModifierType... modifierTypes) {
    ...
    public static boolean isPublic(Field field) {
        return hasModifier(field, ModifierUtils.ModifierType.PUBLIC);
    }
    ...
    public static boolean isPublic(Method method) {
        return hasModifier(method, ModifierUtils.ModifierType.PUBLIC);
    }
    ...
    public static boolean isPublic(Class<?> clazz) {
        return hasModifier(clazz, ModifierUtils.ModifierType.PUBLIC);
    }
    ...
    public static boolean isPublic(Constructor<?> constructor) {
        return hasModifier(constructor, ModifierUtils.ModifierType.PUBLIC);
    }
    ...
    public static boolean isStatic(Field field) {
        return hasModifier(field, ModifierUtils.ModifierType.STATIC);
    }
    ...
    public static boolean isStatic(Method method) {
        return hasModifier(method, ModifierUtils.ModifierType.STATIC);
    }
    ...
    public static boolean isStatic(Class<?> clazz) {
        return hasModifier(clazz, ModifierUtils.ModifierType.STATIC);
    }
     ...
     * @return “与”之后的修饰符
     */
    private static int modifiersToInt(ModifierUtils.ModifierType... modifierTypes) {
