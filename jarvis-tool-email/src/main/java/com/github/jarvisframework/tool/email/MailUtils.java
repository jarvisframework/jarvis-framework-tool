...
/**
 * <p>邮件工具类，基于javax.mail封装</p>
 *
 * @author Doug Wang
 * @since 1.0, 2020-08-31 14:36:57
 */
public class MailUtils {
    ...
    public static String send(Collection<String> tos, Collection<String> ccs, Collection<String> bccs, String subject, String content, boolean isHtml, File... files) {
        return send(GlobalMailAccountEnum.INSTANCE.getAccount(), true, tos, ccs, bccs, subject, content, null, isHtml, files);
    }
    ...
    public static String send(Collection<String> tos, Collection<String> ccs, Collection<String> bccs, String subject, String content, Map<String, InputStream> imageMap, boolean isHtml, File... files) {
        return send(GlobalMailAccountEnum.INSTANCE.getAccount(), true, tos, ccs, bccs, subject, content, imageMap, isHtml, files);
    }
    ...
    private static List<String> splitAddress(String addresses) {
        ...
        if (StringUtils.contains(addresses, ',')) {
            ...
            result = CollectionUtils.newArrayList(addresses);
        }
        return result;
    }
    // ------------------------------------------------------------------------------------------------------------------------ Private method end
