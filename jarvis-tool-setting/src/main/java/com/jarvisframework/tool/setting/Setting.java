package com.jarvisframework.tool.setting;
...
import com.jarvisframework.tool.core.io.resource.UrlResource;
import com.jarvisframework.tool.core.io.watch.SimpleWatcher;
import com.jarvisframework.tool.core.io.watch.WatchMonitor;
import com.jarvisframework.tool.core.io.watch.WatchUtils;
...
import com.jarvisframework.tool.core.util.ResourceUtils;
import com.jarvisframework.tool.core.util.StringUtils;
import com.jarvisframework.tool.log.StaticLog;
import com.jarvisframework.tool.setting.dialect.MyProperties;
...
public class Setting extends AbsSetting implements Map<String, String> {
     ...
     * 默认字符集
     */
    public final static Charset DEFAULT_CHARSET = CharsetUtils.CHARSET_UTF_8;
    ...
    /**
     * 获取group分组下所有配置键值对，组成新的{@link MyProperties}
     *
     * @param group 分组
     * @return Props对象
     */
    public MyProperties getProps(String group) {
    ...
    public Properties toProperties() {
        ...
        for (Entry<String, LinkedHashMap<String, String>> groupEntry : this.groupedMap.entrySet()) {
            ...
            for (Entry<String, String> entry : groupEntry.getValue().entrySet()) {
                properties.setProperty(StringUtils.isEmpty(group) ? entry.getKey() : group + CharUtils.DOT + entry.getKey(), entry.getValue());
            }
        }
        return properties;
    }
    ...
    public List<String> getGroups() {
        return CollectionUtils.newArrayList(this.groupedMap.keySet());
    }
    ...
    public String get(Object key) {
        return this.groupedMap.get(DEFAULT_GROUP, Convert.toString(key));
    }
    ...
    public String remove(Object key) {
        return this.groupedMap.remove(DEFAULT_GROUP, Convert.toString(key));
    }
