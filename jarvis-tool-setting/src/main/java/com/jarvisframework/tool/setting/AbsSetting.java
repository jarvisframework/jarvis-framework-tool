...
import com.jarvisframework.tool.core.getter.OptNullBasicTypeFromStringGetter;
...
import com.jarvisframework.tool.log.LogFactory;
...
public abstract class AbsSetting implements OptNullBasicTypeFromStringGetter<String>, Serializable {
    ...
    public String getString(String key, String defaultValue) {
        return getString(key, DEFAULT_GROUP, defaultValue);
    }
    ...
    public String getStrNotEmpty(String key, String group, String defaultValue) {
        final String value = getByGroup(key, group);
        return ObjectUtils.defaultIfEmpty(value, defaultValue);
    }
    ...
    public <T> T toBean(String group, Class<T> beanClass) {
        return toBean(group, ReflectUtils.newInstanceIfPossible(beanClass));
    }
