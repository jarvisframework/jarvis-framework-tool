...
import com.github.jarvisframework.tool.core.lang.Validator;
import com.github.jarvisframework.tool.core.map.MapUtils;
import com.github.jarvisframework.tool.core.util.HexUtils;
import com.github.jarvisframework.tool.core.util.IdUtils;
import com.github.jarvisframework.tool.core.util.StringUtils;
import com.github.jarvisframework.tool.ctypto.asymmetric.AsymmetricAlgorithmEnum;
import com.github.jarvisframework.tool.ctypto.asymmetric.RSA;
import com.github.jarvisframework.tool.ctypto.asymmetric.Sign;
import com.github.jarvisframework.tool.ctypto.asymmetric.SignAlgorithmEnum;
import com.github.jarvisframework.tool.ctypto.digest.*;
import com.github.jarvisframework.tool.ctypto.symmetric.*;
...
public class SecureUtils {
     ...
     * @since 4.4.1
     */
    public static String generateAlgorithm(AsymmetricAlgorithmEnum asymmetricAlgorithm, DigestAlgorithmEnum digestAlgorithm) {
     ...
     * 生成签名对象，仅用于非对称加密
     *
     * @param asymmetricAlgorithm {@link AsymmetricAlgorithmEnum} 非对称加密算法
     * @param digestAlgorithm     {@link DigestAlgorithmEnum} 摘要算法
     * @return {@link Signature}
     */
    public static Signature generateSignature(AsymmetricAlgorithmEnum asymmetricAlgorithm, DigestAlgorithmEnum digestAlgorithm) {
        try {
    ...
    public static Digester sha1() {
        return new Digester(DigestAlgorithmEnum.SHA1);
    }
    ...
    public static String sha1(File dataFile) {
        return new Digester(DigestAlgorithmEnum.SHA1).digestHex(dataFile);
    }
    ...
    public static Digester sha256() {
        return new Digester(DigestAlgorithmEnum.SHA256);
    }
    ...
    public static String sha256(File dataFile) {
        return new Digester(DigestAlgorithmEnum.SHA256).digestHex(dataFile);
    }

    /**
     * 创建HMac对象，调用digest方法可获得hmac值
     *
     * @param algorithm {@link HmacAlgorithmEnum}
     * @param key       密钥，如果为<code>null</code>生成随机密钥
     * @return {@link HMac}
     * @since 3.3.0
     */
    public static HMac hmac(HmacAlgorithmEnum algorithm, String key) {
    ...
    public static HMac hmacMd5(String key) {
        return hmacMd5(StringUtils.utf8Bytes(key));
    }
    ...
    public static HMac hmacMd5(byte[] key) {
        return new HMac(HmacAlgorithmEnum.HmacMD5, key);
    }
    ...
    public static HMac hmacMd5() {
        return new HMac(HmacAlgorithmEnum.HmacMD5);
    }
    ...
    public static HMac hmacSha1(String key) {
        return hmacSha1(StringUtils.utf8Bytes(key));
    }
    ...
    public static HMac hmacSha1(byte[] key) {
        return new HMac(HmacAlgorithmEnum.HmacSHA1, key);
    }
    ...
    public static HMac hmacSha1() {
        return new HMac(HmacAlgorithmEnum.HmacSHA1);
    }
    ...
    public static String signParamsMd5(Map<?, ?> params, String... otherParams) {
        return signParams(DigestAlgorithmEnum.MD5, params, otherParams);
    }
    ...
    public static String signParamsSha1(Map<?, ?> params, String... otherParams) {
        return signParams(DigestAlgorithmEnum.SHA1, params, otherParams);
    }
    ...
    public static String signParamsSha256(Map<?, ?> params, String... otherParams) {
        return signParams(DigestAlgorithmEnum.SHA256, params, otherParams);
    }
     ...
     * @since 4.0.1
     */
    public static String signParams(DigestAlgorithmEnum digestAlgorithm, Map<?, ?> params, String... otherParams) {
     ...
     * @since 4.0.1
     */
    public static String signParams(DigestAlgorithmEnum digestAlgorithm, Map<?, ?> params, String separator,
                                    String keyValueSeparator, boolean isIgnoreNull, String... otherParams) {
     ...
     * @deprecated 请使用 {@link IdUtils#simpleUUID()}
     */
    @Deprecated
    ...
    public static Cipher createCipher(String algorithm) {
        final Provider provider = GlobalBouncyCastleProviderEnum.INSTANCE.getProvider();
    ...
    public static void disableBouncyCastle() {
        GlobalBouncyCastleProviderEnum.setUseBouncyCastle(false);
    }
}
