...
import com.jarvisframework.tool.ctypto.asymmetric.SM2;
import com.jarvisframework.tool.ctypto.digest.HMac;
import com.jarvisframework.tool.ctypto.digest.HmacAlgorithmEnum;
import com.jarvisframework.tool.ctypto.digest.SM3;
import com.jarvisframework.tool.ctypto.digest.mac.BCHMacEngine;
import com.jarvisframework.tool.ctypto.digest.mac.MacEngine;
import com.jarvisframework.tool.ctypto.symmetric.SM4;
import com.jarvisframework.tool.ctypto.symmetric.SymmetricCrypto;
...
public class SmUtils {
    ...
    public static HMac hmacSm3(byte[] key) {
        return new HMac(HmacAlgorithmEnum.HmacSM3, key);
    }
